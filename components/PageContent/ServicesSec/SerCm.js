...
export default function serCm() {
  ...
  if (path.includes("ar")) {
    ...
    servicesText = "flex flex-col items-end text-right px-3 pb-10 pt-12 bg-[#ffffff] font-arab"
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 p-4 lg:grid-cols-2 xl:grid-cols-3 gap-8 md:p-24 mx-10 bg-[#efefef]">
        ...
        <div>
          ...
          <h2 className="text-2xl md:text-4xl py-3">{t("SER2")}</h2>
            ...
            <Link href="/help" className="btn px-7 py-3 w-full md:w-1/2 text-center font-bold mt-3 text-sm">{t("SER12")}</Link>
          </div>
        </div>
