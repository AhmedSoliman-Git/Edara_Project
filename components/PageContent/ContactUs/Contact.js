...
export default function contact() {
  ...
  let sMain_class =
    "border hover:bg-[#e0b472] hover:text-white duration-300 px-7 text-xl py-5 w-full md:w-1/2 text-center font-Azonix";
  let p_class = "text-xl mb-12 font-PoppinsE";
  if (path.includes("ar")) {
    main_class = "text-3xl font-arab py-6 text-right";
    sMain_class =
      "border hover:bg-[#e0b472] hover:text-white duration-300 px-7 text-xl py-5 w-full md:w-1/2 text-center font-arab text-right";
